module Language.Simple.Inference.SystemCT1999.Prelude where

import Control.Arrow (second)

import Language.Simple.Syntax.Expr
import Language.Simple.Inference.SystemCT1999.Context
import Language.Simple.Inference.SystemCT1999.Substitution (quantified)
import Language.Simple.Prelude.Types
import Language.Simple.Interpretation.Values
